...
namespace Presto
{
    public class BundleConfig
    {
        ...
        private static void RegisterLayout(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Scripts/CalendarUI/js").Include(
                "~/Scripts/CalendarUI/js/jquery-ui.js"));

            bundles.Add(new StyleBundle("~/Scripts/CalendarUI/css").Include(
                "~/Scripts/CalendarUI/css/jquery-ui.css",
                "~/Scripts/CalendarUI/css/styleCalendar.css"));
